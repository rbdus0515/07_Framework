...
// == 스프링이 해당 클래스를 객체로 만들엇 관리를 해야함
// == Bean 등록

// @Contorller, @Service, @Repository 의 부모 어노테이션 == @Component
...
public class ImageDeleteScheduling {
	...
	public void test() {
		...
		// /resources/images/board의 실제 경로를 얻어옴
 ...
 * 
 * 설정 방법 1) servlet-context.xml -> Namespaces 탭 -> task 체크 후 저장 2)
 * servlet-context.xml -> Source 탭 -> <task:annotation-driven/> 추가
 * 
 *
 ...
 * 
 * @Scheduled(fixedRate = 10000) // 이전 작업이 시작된 10초 뒤에 실행
 * 
 * 
